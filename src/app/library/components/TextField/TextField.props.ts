import {TextInputProps, StyleProp, TextStyle, ViewStyle, ViewComponent} from 'react-native';
...
export interface InputBaseProps extends TextInputProps {
    ...
    /**
     * InputWithError color when input disabled
     * @default rgb(159,152,146)
     */
